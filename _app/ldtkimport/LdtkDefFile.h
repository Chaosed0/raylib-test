...
using levels_t = std::vector<Level>;
...
public:
   ...
   using level_iterator = levels_t::iterator;
   using const_level_iterator = levels_t::const_iterator;

   level_iterator levelBegin()
   {
      return m_levels.begin();
   }
   level_iterator levelEnd()
   {
      return m_levels.end();
   }

   const_level_iterator levelBegin() const
   {
      return m_levels.begin();
   }
   const_level_iterator levelEnd() const
   {
      return m_levels.end();
   }

   const_level_iterator levelCBegin() const
   {
      return m_levels.cbegin();
   }
   const_level_iterator levelCEnd() const
   {
